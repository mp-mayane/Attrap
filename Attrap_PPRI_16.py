...
class Attrap_PPRI_16(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.charente.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement-Chasse-Eau-Risques/Prevention-des-risques-naturels-et-technologiques/L-Etat-face-aux-risques/Les-Plans-de-Prevention-des-Risques'
    full_name = 'Préfecture de Charente'
    short_code = 'pref16'
