...
class Attrap_PPRI_24(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.dordogne.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement-Eau-Biodiversite-Risques/Risques-naturels-et-technologiques/Plans-de-prevention-des-risques'
    full_name = 'Préfecture de Dordogne'
    short_code = 'pref24'
    timezone = 'Europe/Paris'

    # Configuration des widgets à analyser
    #year_regex = '(?:(?:[Rr]ecueils{0,1} des [Aa]ctes [Aa]dministratifs de la [Pp]réfecture de l\'Isère[ -]*)|(?:Année ))([0-9]{4})'
    denomation_regex = 'PPRI|PPRL|PPRN|pprn'
