...
class Attrap_PPRI_81(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.tarn.gouv.fr'
    raa_page = f'{hostname}/index.php/Actions-de-l-Etat/Eau-Environnement-Prevention-des-risques/Prevention-des-risques-naturels-et-technologiques/Risques-Naturels/Risque-Inondation/Les-plans-de-prevention-des-risques-d-inondation-PPRi/(offset)/10'
