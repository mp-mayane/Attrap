...
class Attrap_PPRI_94(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.val-de-marne.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement-et-prevention-des-risques/Risques-naturels/Risques-naturels-inondations'
    full_name = 'Préfecture de Val-de-Marne'
    short_code = 'pref94'
