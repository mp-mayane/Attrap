...
class Attrap_PPRI_21(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.cote-dor.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Risques-majeurs.-naturels-et-technologiques/Inondations/Les-Plans-de-Prevention-des-Risques-Naturels-PPRN-approuves'
    full_name = 'Préfecture de Côte d\'or'
    short_code = 'pref21'
