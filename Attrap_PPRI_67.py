...
class Attrap_PPRI_67(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.bas-rhin.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Prevention-des-risques-naturels-et-technologiques/Presentation-des-differents-risques/Risque-inondation/PPRI-approuves'
    full_name = 'Préfecture des Bas-Rhin'
    short_code = 'pref67'
