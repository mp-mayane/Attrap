...
class Attrap_PPRI_64(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.pyrenees-atlantiques.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Cadre-de-vie-eau-environnement-et-risques-majeurs/Plans-de-prevention-des-risques'
    full_name = 'Préfecture du Pyrénées-Atlantiques'
    short_code = 'pref64'
