...
class Attrap_PPRI_19(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.correze.gouv.fr'
    raa_page = f'{hostname}/Action-de-l-Etat/Securite-et-protection-des-populations/Securite-Civile/Risques-naturels-et-technologiques/Risque-Inondation/PPRI-approuves'
    full_name = 'Préfecture de Corrèze'
    short_code = 'pref19'
