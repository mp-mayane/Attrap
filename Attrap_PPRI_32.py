...
class Attrap_PPRI_32(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.gers.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Prevention-des-risques-naturels-et-technologiques/Risques-naturels-inondation-retrait-gonflement-argiles-sismique/Risque-inondation/Les-Plans-de-Prevention-du-Risque-Inondation-PPRi-dans-le-Gers'
    full_name = 'Préfecture de Gers'
    short_code = 'pref32'
