...
class Attrap_PPRI_36(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.indre.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Securite-et-protection-de-la-population2/Prevention-des-risques-majeurs/Plans-et-documents/Le-plan-de-prevention-des-risques-PPR/PPR'
    full_name = 'Préfecture d\'Indre'
    short_code = 'pref36'
