...
class Attrap_PPRI_78(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.yvelines.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement-et-prevention-des-risques/Prevention-des-risques-naturels-et-technologiques/Les-risques-majeurs-dans-le-departement/Le-risque-inondation/Plan-de-prevention-des-risques-d-inondation-PPRI-de-la-vallee-de-Bievre-et-du-ru-de-Vauhallan'
    full_name = 'Préfecture des Yvelines'
    short_code = 'pref78'
