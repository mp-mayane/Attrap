...
class Attrap_PPRI_57(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.meurthe-et-moselle.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Prevention-des-risques/Plan-de-prevention-des-risques-naturels-et-miniers/Les-Plans-de-Prevention-des-Risques-Naturels-approuves'
    full_name = 'Préfecture du Moselle'
    short_code = 'pref57'
