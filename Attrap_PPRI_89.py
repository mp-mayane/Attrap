...
class Attrap_PPRI_89(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.yonne.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Securite-et-prevention-des-risques/Risques-majeurs/Risques-naturels/PPR-inondation-de-l-Yonne-Procedure-d-elaboration-revision'
    full_name = 'Préfecture d\'Yonne'
    short_code = 'pref89'
