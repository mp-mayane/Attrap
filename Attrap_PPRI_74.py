...
class Attrap_PPRI_74(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.haute-savoie.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Prevenir-le-risque-et-se-proteger/Risques-naturels/Donnees-communales-aleas-et-PPRN/Publier'
    full_name = 'Préfecture de Haut-Savoie'
    short_code = 'pref74'
