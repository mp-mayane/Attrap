...
class Attrap_PPRI_974(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.reunion.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Securite-protection-des-personnes-et-des-biens/Protection-civile/Prevention-des-risques-naturels-et-technologiques/Les-risques-naturels-a-La-Reunion/Plans-de-prevention-des-risques-naturels-PPRN-et-PAC'
    full_name = 'Préfecture de Guyane'
    short_code = 'pref974'
