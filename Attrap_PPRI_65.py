...
class Attrap_PPRI_65(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.hautes-pyrenees.gouv.fr'
    raa_page = f'{hostname}/Publications/Enquetes-publiques-et-consultation-du-Public/Enquetes-publiques/Historique-des-enquetes-cloturees/Plan-de-Prevention-des-Risques-PPR'
