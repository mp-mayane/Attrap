...
class Attrap_PPRI_07(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.ardeche.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement.-risques-naturels-et-technologiques/Prevention-des-risques-naturels/Les-risques-naturels-et-miniers/Plan-de-prevention-des-risques-naturels-previsibles-PPR'
    full_name = 'Préfecture d\'Ardèche'
    short_code = 'pref07'
