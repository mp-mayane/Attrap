...
class Attrap_PPRI_86(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.vienne.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement-risques-naturels-et-technologiques/Risques-naturels-et-technologiques-majeurs/Les-risques-naturels/Les-plans-de-prevention-des-risques-naturels-PPRN'
    full_name = 'Préfecture de la Vienne'
    short_code = 'pref86'
