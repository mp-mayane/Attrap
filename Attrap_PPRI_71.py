...
class Attrap_PPRI_71(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.saone-et-loire.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement-risques-naturels-et-technologiques/Risques-naturels-et-technologiques/Les-Plans-de-Prevention-du-Risque-Inondation-PPRI'
    full_name = 'Préfecture des Saône-et-Loire'
    short_code = 'pref71'
