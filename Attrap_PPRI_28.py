...
class Attrap_PPRI_28(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.eure-et-loir.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Risques-naturels-et-technologiques/Risques-inondation'
    full_name = 'Préfecture de l\'Eure et Loir'
    short_code = 'pref28'
