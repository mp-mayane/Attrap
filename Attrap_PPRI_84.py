...
class Attrap_PPRI_84(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.vaucluse.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Transition-ecologique-et-prevention-des-risques/Prevention-des-risques/Risques-naturels/Inondation/Plans-de-Prevention-des-Risques-d-inondation-PPRi2'
    full_name = 'Préfecture du Vaucluse'
    short_code = 'pref84'
