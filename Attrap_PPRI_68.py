...
class Attrap_PPRI_68(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.haut-rhin.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Information-preventive-sur-les-risques-majeurs/Risques-Naturels/Risque-inondation/Les-plans-de-prevention-des-risques-inondation-PPRI/Le-PPRI'
    full_name = 'Préfecture des Haut-Rhin'
    short_code = 'pref68'
