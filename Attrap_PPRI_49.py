...
class Attrap_PPRI_49(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.maine-et-loire.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Prevention-des-risques-naturels-et-technologiques/Inondations/Les-Plans-de-Prevention-des-Risques-inondation-PPRi'
    full_name = 'Préfecture du Maine-et-Loire'
    short_code = 'pref49'
