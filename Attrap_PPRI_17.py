...
class Attrap_PPRI_17(Attrap_prefdpt):

    # Configuration de la préfecture
    hostname = 'https://www.charente-maritime.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement-risques-naturels-et-technologiques/Risques-naturels-et-technologiques/Les-plans-de-prevention-des-risques-naturels-PPRN-approuves'
    full_name = 'Préfecture de Charente-Maritime'
    short_code = 'pref17'
