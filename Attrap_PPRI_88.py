...
class Attrap_PPRI_88(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.vosges.gouv.fr'
    raa_page = f'{hostname}/index.php/Actions-de-l-Etat/Environnement/Risques-environnementaux/Liste-des-communes-couvertes-par-un-PPR-ou-classees-en-zone-sismique-radon-ou-SIS'
