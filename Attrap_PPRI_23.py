...
class Attrap_PPRI_23(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.data.gouv.fr'
    raa_page = f'{hostname}/plan-de-prevention-des-risques-pprn-de-la-creuse-hors-agglomeration-dargenton-sur-creuse/'
