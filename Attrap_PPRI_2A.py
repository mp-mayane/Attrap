...
class Attrap_PPRI_2A(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.corse-du-sud.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Securite-protection-des-populations/Prevention-des-risques/Les-Plans-de-Prevention-des-Risques-Naturels/Le-risque-inondation'
    full_name = 'Préfecture de Corse du Sud'
    short_code = 'pref2A'
