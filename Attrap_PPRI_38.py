...
class Attrap_PPRI_38(Attrap_prefdpt):

    # Configuration de la préfecture
    hostname = 'https://www.isere.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Risques-majeurs/Collectivites/Risques-naturels/Plans-de-Prevention-des-Risques-naturels-et-inondations-PPRN-PPRI/Plan-de-Prevention-du-Risque-Inondation-PPRI'
