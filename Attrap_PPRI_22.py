...
class Attrap_PPRI_22(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.cotes-darmor.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Risques-naturels-technologiques-et-miniers/PPRN-Plans-de-prevention-des-risques-naturels/PPRI-approuves'
    full_name = 'Préfecture de Côtes d\'amor'
    short_code = 'pref22'
