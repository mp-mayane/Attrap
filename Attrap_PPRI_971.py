...
class Attrap_PPRI_971(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.guadeloupe.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Securite/Prevention-securite-des-personnes-et-des-biens/Defense-et-protection-civiles/Information-preventive/PPRN-plan-de-prevention-des-risques-naturels'
    full_name = 'Préfecture de Guadeloupe'
    short_code = 'pref971'
