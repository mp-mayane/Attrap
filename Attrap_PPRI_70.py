...
class Attrap_PPRI_70(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.haute-saone.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement/Prevention-des-risques-et-nuisances/Risques-naturels-et-technologiques/PPRI-en-Haute-Saone'
    full_name = 'Préfecture des Haute-Saône'
    short_code = 'pref70'
