...
class Attrap_PPRI_69(Attrap_prefdpt):

    # Configuration de la préfecture
    hostname = 'https://www.rhone.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Securite-et-protection-de-la-population/La-securite-civile/Les-risques-majeurs/Les-risques-majeurs-dans-le-Rhone/Risques-inondations-PPRI-et-PAC'
