...
class Attrap_PPRI_972(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.martinique.developpement-durable.gouv.fr'
    raa_page = f'{hostname}/le-plan-de-prevention-des-risques-naturels-de-la-a999.html'
    full_name = 'Préfecture de Martinique'
    short_code = 'pref972'
