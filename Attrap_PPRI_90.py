...
class Attrap_PPRI_90(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.territoire-de-belfort.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Securite-Prevention/Prevention-des-risques/Les-risques-naturels/Risque-inondation'
    full_name = 'Préfecture du Territoire de Belfort'
    short_code = 'pref90'
