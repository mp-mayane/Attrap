...
class Attrap_PPRI_72(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.sarthe.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement-transition-energetique-et-prevention-des-risques/Risques/Risques-naturels/Inondation/PPRI-Plans-de-Prevention-du-Risque-Inondation/Informations-generales-sur-les-PPRI/Informations-generales-sur-les-PPRI'
    full_name = 'Préfecture de Sarthe'
    short_code = 'pref72'
