...
class Attrap_PPRI_95(Attrap_prefdpt):
    # Configuration de la préfecture
    hostname = 'https://www.val-doise.gouv.fr'
    raa_page = f'{hostname}/Actions-de-l-Etat/Environnement-risques-et-nuisances/Prevention-Risques/Risques-naturels/Les-plans-de-prevention-des-risques-naturels-PPRN'
    full_name = 'Préfecture de Val-d\'Oise'
    short_code = 'pref95'
